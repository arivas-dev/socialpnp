		...
		<ul class="social_links">
				...
				<li>
					<a title="Editar mi numero fijo">
						...
						<label id="telefono1" class="editStart" data-type="text"><?php echo $texto_cel1 ?></label>
					</a>
				</li>
				<?php 
				...
				<li>
					<a title="Editar mi numero movil">
						...
						<label id="telefono2" class="editStart" data-type="text"><?php echo $texto_cel2 ?></label>
					</a>
				</li>
